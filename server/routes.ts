...
import {
  ...
  gameTimeSlots,
  eventSettings,
  eventAgeGroupFees, // Added import for eventAgeGroupFees
  ageGroupSettings, // Added import for ageGroupSettings
} from "@db/schema";
        ...
        const [newEvent] = await db.transaction(async (tx) => {
          ...
          if (formData.selectedScopeId && formData.selectedAgeGroupIds) {
            ...
            for (const group of selectedAgeGroups) {
              ...
              // Handle fee assignments for new group
